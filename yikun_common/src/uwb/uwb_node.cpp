...
int main(int argc,char* argv[])
{
  ...
  anchorArray.A1 = Eigen::Vector3f(0,     5.4, 2);
  anchorArray.A2 = Eigen::Vector3f(7.8,  5.4, 2);
  anchorArray.A3 = Eigen::Vector3f(7.8,  0,    2.5);
  ...
  //Turtlebot接口初始化
#if 0
#define TURTLEBOT1 "192.168.99.51"  //tag0
#define TURTLEBOT2 "192.168.99.52"  //tag1
#define TURTLEBOT3 "192.168.99.53"  //tag2
#define TURTLEBOT4 "192.168.99.54"  //tag3
#define TURTLEBOT5 "192.168.99.55"  //tag4
#endif
