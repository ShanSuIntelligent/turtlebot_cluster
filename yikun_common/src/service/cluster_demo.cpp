...
int main(int argc,char* argv[])
{
  ...
  private_nh.param("turtlebot_01",turtlebot_01,std::string("192.168.99.61"));
  private_nh.param("turtlebot_02",turtlebot_02,std::string("192.168.99.62"));
  private_nh.param("turtlebot_03",turtlebot_03,std::string("192.168.99.63"));
  private_nh.param("turtlebot_04",turtlebot_04,std::string("192.168.99.64"));
  private_nh.param("turtlebot_05",turtlebot_05,std::string("192.168.99.65"));
